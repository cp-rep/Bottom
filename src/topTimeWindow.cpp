/*
  ...
  Description:
   Class implementation for the TopTimeWindow class.
*/
...
/*
  Function:
   TopTimeWindow Constructor
   
  Description:
   The class constructor for creating TopTimeWindow objects and 
  ...
  NONE
*/
TopTimeWindow::TopTimeWindow(WINDOW* win,
			     ...
			     const short& startX) : CursesWindow(win,
								 ...
								 startX)
{
} // end of "TopTimeWindow Constructor"

/*
  File:
   miBMemAvailWindow.cpp
   
  Description:
   Class implementation for the MiBMemAvailWindow class.
*/
...
/*
  Function:
   MiBMemAvailWindow Constructor
   
  Description:
   The class constructor for creating MiBMemAvailWindow objects and 
  ...
  NONE
*/
MiBMemAvailWindow::MiBMemAvailWindow(WINDOW* win,
				     ...
				     const short& startX) : CursesWindow(win,
									 ...
									 startX)
{
} // end of "MiBMemAvailWindow Constructor"

/*
  File:
   miBSwapTotalWindow.cpp
   
  Description:
   Class implementation for the MiBSwapTotalWindow class.
*/
...
/*
  Function:
   MiBSwapTotalWindow Constructor
   
  Description:
   The class constructor for creating MiBSwapTotalWindow objects and 
  ...
  NONE
*/
MiBSwapTotalWindow::MiBSwapTotalWindow(WINDOW* win,
				       ...
				       const short& startX) : CursesWindow(win,
									   ...
									   startX)
{
} // end of "MiBSwapTotalWindow Constructor"

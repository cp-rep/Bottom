/*
  File:
   miBMemFreeWindow.cpp
   
  Description:
   Class implementation for the MiBMemFreeWindow class.
*/
...
/*
  Function:
   MiBMemFreeWindow Constructor
   
  Description:
   The class constructor for creating MiBMemFreeWindow objects and 
  ...
  NONE
*/
MiBMemFreeWindow::MiBMemFreeWindow(WINDOW* win,
		       ...
		       const short& startX) : CursesWindow(win,
							   ...
							   startX)
{
} // end of "MiBMemFreeWindow Constructor"

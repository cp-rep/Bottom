/*
  ...
  Description:
   Class implementation for the CpuGraphWindow class.
 */
...
/*
  Function:
   CpuGraphWindow Constructor
   
  Description:
   The class constructor for creating CpuGraphWindow objects and 
  ...
  NONE
*/
CpuGraphWindow::CpuGraphWindow(WINDOW* win,
			       ...
			       const short& startX) : CursesWindow(win,
								   ...
								   startX)
{
} // end of "CpuGraphWindow Constructor"

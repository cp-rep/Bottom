/*
  File:
   TasksStoppedWindow.cpp
   
  Description:
   Class implementation for the TasksStoppedWindow class.
*/
...
/*
  Function:
   TasksStoppedWindow Constructor
   
  Description:
   The class constructor for creating TasksStoppedWindow objects and 
  ...
  NONE
*/
TasksStoppedWindow::TasksStoppedWindow(WINDOW* win,
				       ...
				       const short& startX) : CursesWindow(win,
									   ...
									   startX)
{
} // end of "TasksStoppedWindow Constructor"

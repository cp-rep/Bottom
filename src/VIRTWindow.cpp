/*
  ...
  Description:
   Class implementation for the VIRTWindow class.
*/
...
/*
  Function:
   VIRTWindow Constructor
   
  Description:
   The class constructor for creating VIRTWindow objects and 
  ...
  NONE
*/
VIRTWindow::VIRTWindow(WINDOW* win,

/*
  ...
  Description:
   Class implementation for the TopUpWindow class.
*/
...
/*
  Function:
   TopUpWindow Constructor
   
  Description:
   The class constructor for creating TopUpWindow objects and 
  ...
  NONE
*/
TopUpWindow::TopUpWindow(WINDOW* win,
			 ...
			 const short& startX) : CursesWindow(win,
							     ...
							     startX)
{
} // end of "TopUpWindow Constructor"

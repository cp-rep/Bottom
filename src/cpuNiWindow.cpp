/*
  ...
  Description:
   Class implementation for the CpuNiWindow class.
*/
...
/*
  Function:
   CpuNiWindow Constructor
   
  Description:
   The class constructor for creating CpuNiWindow objects and 
  ...
  NONE
*/
CpuNiWindow::CpuNiWindow(WINDOW* win,
			 ...
			 const short& startX) : CursesWindow(win,
							     ...
							     startX)
{
} // end of "CpuNiWindow Constructor"

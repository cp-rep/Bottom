/*
  File:
   miBBuffCacheWindow.cpp
   
  Description:
   Class implementation for the MiBBuffCacheWindow class.
*/
...
/*
  Function:
   MiBBuffCacheWindow Constructor
   
  Description:
   The class constructor for creating MiBBuffCacheWindow objects and 
  ...
  NONE
*/
MiBBuffCacheWindow::MiBBuffCacheWindow(WINDOW* win,
		       ...
		       const short& startX) : CursesWindow(win,
							   ...
							   startX)
{
} // end of "MiBBuffCacheWindow Constructor"

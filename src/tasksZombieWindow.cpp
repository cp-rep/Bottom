/*
  File:
   TasksZombieWindow.cpp
   
  Description:
   Class implementation for the TasksZombieWindow class.
*/
...
/*
  Function:
   TasksZombieWindow Constructor
   
  Description:
   The class constructor for creating TasksZombieWindow objects and 
  ...
  NONE
*/
TasksZombieWindow::TasksZombieWindow(WINDOW* win,
				     ...
				     const short& startX) : CursesWindow(win,
									 ...
									 startX)
{
} // end of "TasksZombieWindow Constructor"

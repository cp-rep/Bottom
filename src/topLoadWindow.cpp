/*
  ...
  Description:
   Class implementation for the TopLoadWindow class.
*/
...
/*
  Function:
   TopLoadWindow Constructor
   
  Description:
   The class constructor for creating TopLoadWindow objects and 
  ...
  NONE
*/
TopLoadWindow::TopLoadWindow(WINDOW* win,
			     ...
			     const short& startX) : CursesWindow(win,
								 ...
								 startX)
{
} // end of "TopLoadWindow Constructor"

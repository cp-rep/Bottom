/*
  ...
  Description:
   Class implementation for the TopUsersWindow class.
*/
...
/*
  Function:
   TopUsersWindow Constructor
   
  Description:
   The class constructor for creating TopUsersWindow objects and 
  ...
  NONE
*/
TopUsersWindow::TopUsersWindow(WINDOW* win,
		       ...
		       const short& startX) : CursesWindow(win,
							   ...
							   startX)
{
} // end of "TopUsersWindow Constructor"

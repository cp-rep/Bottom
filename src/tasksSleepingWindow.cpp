/*
  File:
   TasksSleepingWindow.cpp
   
  Description:
   Class implementation for the TasksSleepingWindow class.
*/
...
/*
  Function:
   TasksSleepingWindow Constructor
   
  Description:
   The class constructor for creating TasksSleepingWindow objects and 
  ...
  NONE
*/
TasksSleepingWindow::TasksSleepingWindow(WINDOW* win,
		       ...
		       const short& startX) : CursesWindow(win,
							   ...
							   startX)
{
} // end of "TasksSleepingWindow Constructor"

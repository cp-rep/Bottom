/*
  ...
  Description:
   Class implementation for the CpuUsWindow class.
*/
...
/*
  Function:
   CpuUsWindow Constructor
   
  Description:
   The class constructor for creating CpuUsWindow objects and 
  ...
  NONE
*/
CpuUsWindow::CpuUsWindow(WINDOW* win,
			 ...
			 const short& startX) : CursesWindow(win,
							     ...
							     startX)
{
} // end of "CpuUsWindow Constructor"

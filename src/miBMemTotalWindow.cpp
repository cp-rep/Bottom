/*
  File:
   miBMemTotalWindow.cpp
   
  Description:
   Class implementation for the MiBMemTotalWindow class.
*/
...
/*
  Function:
   MiBMemTotalWindow Constructor
   
  Description:
   The class constructor for creating MiBMemTotalWindow objects and 
  ...
  NONE
*/
MiBMemTotalWindow::MiBMemTotalWindow(WINDOW* win,
				     ...
				     const short& startX) : CursesWindow(win,
									 ...
									 startX)
{
} // end of "MiBMemTotalWindow Constructor"

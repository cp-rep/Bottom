/*
  File:
   miBSwapFreeWindow.cpp
   
  Description:
   Class implementation for the MiBSwapFreeWindow class.
*/
...
/*
  Function:
   MiBSwapFreeWindow Constructor
   
  Description:
   The class constructor for creating MiBSwapFreeWindow objects and 
  ...
  NONE
*/
MiBSwapFreeWindow::MiBSwapFreeWindow(WINDOW* win,
				     ...
				     const short& startX) : CursesWindow(win,
									 ...
									 startX)
{
} // end of "MiBSwapFreeWindow Constructor"

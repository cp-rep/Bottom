/*
  ...
  Description:
   Class implementation for the CpuSiWindow class.
*/
...
/*
  Function:
   CpuSiWindow Constructor
   
  Description:
   The class constructor for creating CpuSiWindow objects and 
  ...
  NONE
*/
CpuSiWindow::CpuSiWindow(WINDOW* win,
			 ...
			 const short& startX) : CursesWindow(win,
							     ...
							     startX)
{
} // end of "CpuSiWindow Constructor"

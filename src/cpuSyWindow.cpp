/*
  ...
  Description:
   Class implementation for the CpuSyWindow class.
*/
...
/*
  Function:
   CpuSyWindow Constructor
   
  Description:
   The class constructor for creating CpuSyWindow objects and 
  ...
  NONE
*/
CpuSyWindow::CpuSyWindow(WINDOW* win,
			 ...
			 const short& startX) : CursesWindow(win,
							     ...
							     startX)
{
} // end of "CpuSyWindow Constructor"
